...
module.exports.createCampground = async (req, res) => {
    ...
    try {
        ...
        req.flash('error', `Either the location was not found or the campground wasn't saved. Please try again.`);
...
module.exports.updateCampground = async (req, res) => {
    ...
    if (req.files.length > 0) {
        const imgs = req.files.map(f => ({ url: f.path.replace('/upload', '/upload/w_1920,h_1080,c_fill'), filename: f.filename }))
